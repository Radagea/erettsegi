<?php
	if ($_SESSION[login_jog]>0)
	{
		...
		{
			if ($_SESSION[login_id]==$row[login_id])
			{
				$ffdb++;
			}
		}
		print "
			<table border=0 style='margin-top:30px;'>
				...
				<tr>
					...
					<td align=center>
						<ul class=mainmenu>
							<li><a href='index.php?op=jelszocsere'>Jelszó változtatás</a></li>
						</ul>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align=center>
						<ul class=mainmenu>		
							<li><a href='index.php?op=emailcsere'>Email változtatás</a></li>
						</ul>		
					</td>
				</tr>
				<tr>
